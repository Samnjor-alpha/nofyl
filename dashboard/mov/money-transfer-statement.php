...
<?php include('inc/container.php'); ?>
    <div class="container">
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            <div class="row-title">Money Transfer Statement</div>

            <div class="row" style="padding-left:5%;">

                <div class="col02"><label for="title">Upload Statement:</label></div>
...
text/plain, application/pdf, image/*"
            ...
            <div class="row">
                ...
                <input type="submit" name="upload" value="Upload Statement"

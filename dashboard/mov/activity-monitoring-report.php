...
<?php include('inc/container.php'); ?>
    <div class="container">
        ...
        <form>
            ...
            <div class="row-title">QUARTERLY UPDATE<br>
            ...
            <div class="row" style="padding-left:5%;">
                ...
                <div class="col02"><label for="title">Details of Achieved Results:</label></div>

                <div class="col02-tab-text">
                    <h3>M&E Actions within the Project</h3>
                    <table class="table table-bordered table-striped">
                        <thead>
            ...
            <div class="row" style="padding-left:5%;">
                ...
                <div class="col02"><label for="title">Details of Training for the Reporting Period:</label></div>
